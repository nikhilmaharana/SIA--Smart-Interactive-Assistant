...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "where", "when", "why", "who", "whose", "whom", "can you", "what's", "where's", "how's"]
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        self.maiximize_button = QPushButton()
        self.maximize_icon = QIcon(GraphicsDirectoryPath('Maximize.png'))
        self.restore_icon = QIcon(GraphicsDirectoryPath('Minimize.png'))
        self.maiximize_button.setIcon(self.maximize_icon)
        self.maiximize_button.setFlat(True)
        self.maiximize_button.setStyleSheet("background-color: white")
        self.maiximize_button.clicked.connect(self.maximizeWindow)
        ...
        layout.addWidget(self.maiximize_button)
    ...
    def maximizeWindow(self):
        if self.parent().isMaximized():
            ...
            self.maiximize_button.setIcon(self.restore_icon)
